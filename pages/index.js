      ...
      <main className="flex flex-col items-center justify-around flex-1 w-full max-h-[90%] px-8 text-center bg-maximum-red space-y-8">
        ...
        <div className="flex flex-wrap items-center justify-around max-w-4xl -mt-16 sm:w-full">
          <a className="text-center rounded-xl text-maximum-red focus:text-maximum-black sm:w-5/6 lg:w-1/2 hover:text-black">
            ...
            <p className="text-sm">
              To join our NFT Raise, please send the NFT(s), only ethereum
              mainnet or Avax C-Chain accepted, that you would like to
              contribute to:
              ...
              <span className="block p-4 text-[8px] sm:text-xs">
                ...
                our decision of how many joke tokens to send you. Fungible
                tokens are not a substitute for NFTs. Fungible tokens received
                will not result in reciprocation of joke tokens. Any ERC20
                tokens sent will not be returned. This raise ends whenever we
                decide it does.
              </span>
            </p>
          </a>
